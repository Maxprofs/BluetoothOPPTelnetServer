...
public class TypeConverter
{
	...
	public BatchInfo[] GetBatchInfo(String as,FILETYPE hint,Object data)
	{
	...
	private BatchInfo[] StringConvertTo(String as,TypeConverter.FILETYPE to, String data)
	{
		...
		try
		{
			...
			{
				return new BatchInfo[]{new BatchInfo(data,Utility.readTextFile(data).getBytes(session.getPreferenceHelper().getTextFileEncoding()))};
			}
